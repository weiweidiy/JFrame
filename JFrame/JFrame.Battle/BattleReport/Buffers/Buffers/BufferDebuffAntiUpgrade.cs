...
//    {
//        float value;
//        public BufferDebuffAntiUpgrade(IBattleUnit caster, bool isBuff, string UID, int id, int foldCount, float[] executeArgs, IBattleTrigger trigger, IBattleTargetFinder finder, List<IBattleExecutor> exutors) : base(caster,isBuff, UID, id, foldCount, executeArgs, trigger, finder, exutors)
//        {
