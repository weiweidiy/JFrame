...
namespace JFrame
{
    ...
    /// type 12
    /// </summary>
    public class RandomFriendFinder : BaseTargetFinder
    {
        public RandomFriendFinder(BattlePoint selfPoint, IPVPBattleManager manger, float arg) : base(selfPoint, manger, arg)
        {
        }

        public override List<IBattleUnit> FindTargets(object[] args)
        {
            var units = manger.GetUnits(manger.GetFriendTeam(Owner.Owner));
