...
//    {
//        protected TriggerFindUnits(CombatBaseFinder finder) : base(finder)
//        {
//        }
...
//            if (teamArg == 0) //找自己
//                return context.CombatManager.GetFriendTeamId(_extraData.Caster);

//            if (teamArg == 1)
//                return context.CombatManager.GetOppoTeamId(_extraData.Caster);
...
//        protected abstract void Filter(List<CombatUnit> lst);
