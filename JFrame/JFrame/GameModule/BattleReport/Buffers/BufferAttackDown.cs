...
{
    /// <summary>
    /// 攻击力下降 参数 1： 持续时间， 参数2： 攻击力下降百分比
    /// </summary>
    public class BufferAttackDown : DurationBuffer
    {
        int value;
        public BufferAttackDown(string UID, int id, int foldCount, float[] args) : base(UID, id, foldCount, args)
        {
        }
        ...
        {
            base.OnAttach(unit);
            value = unit.AtkReduce((int)GetValue());
        }
