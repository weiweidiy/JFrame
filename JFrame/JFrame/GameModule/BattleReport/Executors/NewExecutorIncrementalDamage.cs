...
namespace JFrame
{
    ...
    /// </summary>
    public class NewExecutorIncrementalDamage : NewExecutorDamage
    {
        /// <summary>
        /// 递增次数
        /// </summary>
        ...
        public NewExecutorIncrementalDamage(FormulaManager formulaManager, float[] args) : base(formulaManager, args)
        {
            if (args.Length >= 6)
            {
