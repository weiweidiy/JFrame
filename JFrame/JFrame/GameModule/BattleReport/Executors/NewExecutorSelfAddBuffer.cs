...
namespace JFrame
{
    ...
    /// </summary>
    public class NewExecutorSelfAddBuffer : NewExecutorTargetAddBuffer
    {
        public NewExecutorSelfAddBuffer(FormulaManager formulaManager, float[] args) : base(formulaManager, args)
        {
        }
