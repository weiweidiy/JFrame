...
namespace JFrame
{
    ...
    /// </summary>
    public class NewExecutorTargetAddBuffer : NewBaseExecutor
    {
        ...
        public NewExecutorTargetAddBuffer(FormulaManager formulaManager, float[] args) : base(formulaManager, args)
        {
