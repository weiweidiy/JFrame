...
namespace JFrame
{
    ...
    public class NewOrderFriendsFinder : NewBaseTargetFinder
    {
        public NewOrderFriendsFinder(BattlePoint selfPoint, IPVPBattleManager manger, float arg) : base(selfPoint, manger, arg)
        {
        }
