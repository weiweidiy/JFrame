...
namespace JFrame
{
    ...
    public class NewOrderOppoTopAtkFinder : NewBaseTargetFinder
    {
        public NewOrderOppoTopAtkFinder(BattlePoint selfPoint, IPVPBattleManager manger, float arg) : base(selfPoint, manger, arg)
        {
        }
