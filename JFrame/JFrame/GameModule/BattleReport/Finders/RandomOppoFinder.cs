...
namespace JFrame
{
    ...
    public class NewRandomOppoFinder : NewBaseTargetFinder
    {
        public NewRandomOppoFinder(BattlePoint selfPoint, IPVPBattleManager manger, float arg) : base(selfPoint, manger, arg)
        {
        }
